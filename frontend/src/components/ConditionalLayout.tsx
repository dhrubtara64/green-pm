      ...
      <div className="flex h-screen overflow-hidden">
        <nav className="w-56 shrink-0 bg-white border-r border-slate-200 flex flex-col">
          <div className="px-4 py-5 border-b border-slate-200">
            ...
            <p className="text-slate-500 text-xs mt-1.5">Bellary CCGT — 900 MW</p>
          </div>

          <div className="flex-1 px-2 py-4 space-y-1">
            <NavLink href="/" label="Dashboard" icon="▤" />
            <NavLink href="/changes" label="Change Register" icon="◈" />
            <NavLink href="/subcontractors" label="Subcontractor Watch" icon="◉" />
